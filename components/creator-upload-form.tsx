...
function CreatorForm() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    //   res["cid"] = cid;
      ...
      res["url"] = creatorPageUrl(contractAddress);
      setResult(res);
      // scroll to result
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    The handle defines the unique url of the page. The handle should be lower case and contain no special characters or spaces - only hyphens
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="Describe the type of content you produce"
                      {...field}
                    />
                  </FormControl>
